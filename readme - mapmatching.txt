GEOSPATIAL VISION AND VISUALISATION:(CS-513)
...
SUBMITTED BY:
	...
	Ravikiran Puttaraju (A20387024)
	Puneeth Bondugala Reddy (A20379964)

--------------------------------------------------------------------------------------------------------------------------------------
Place the entire deploymment package as it is in a drive folder

Open the command peompt from that same folder.

Run the python file whihc is "ComputeSlope_MapMatch.py"

Output files will be generated which contain the matched data as well as the slope data
File names would be SlopesHW2.csv and MapMacthHW2.csv
